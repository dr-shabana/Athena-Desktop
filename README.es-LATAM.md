...
<br/>
<p align="center">
  <a href="https://athena-agent.dr-shabana.com/docs/"><img src="https://img.shields.io/badge/Documentación-athena--agent.dr-shabana.com-FFD700?style=for-the-badge" alt="Documentación"></a>
  ...
  <a href="https://github.com/dr-shabana/Athena-Desktop/blob/main/LICENSE"><img src="https://img.shields.io/badge/Licencia-MIT-green?style=for-the-badge" alt="Licencia: MIT"></a>
  <a href="https://athenaagents.cc/"><img src="https://img.shields.io/badge/Descargar-Releases-FF6600?style=for-the-badge" alt="Releases"></a>
  <a href="https://github.com/dr-shabana/Athena-Desktop/stargazers">
  <img src="https://img.shields.io/github/stars/dr-shabana/Athena-Desktop?style=for-the-badge&color=FFD700&label=Estrellas" alt="Estrellas">
</a>
  <a href="https://github.com/dr-shabana/Athena-Desktop/releases/">
  <img src="https://img.shields.io/github/downloads/dr-shabana/Athena-Desktop/total?style=for-the-badge&color=00B496&label=Descargas%20Totales" alt="Descargas">
</a>
</p>

> **Este proyecto está en desarrollo activo.** Las funciones pueden cambiar y algunas cosas podrían no funcionar perfectamente. Si encuentras un problema o tienes una idea, [abre un issue](https://github.com/dr-shabana/Athena-Desktop/issues). ¡Las contribuciones son bienvenidas!
...
Athena Q es una aplicación nativa de escritorio para instalar, configurar y chatear con [Athena Agent](https://github.com/dr-shabana/athena-agent) — un asistente de IA con autoaprendizaje, uso de herramientas, mensajería multiplataforma y un ciclo de aprendizaje cerrado.

En lugar de manejar el CLI a mano, la app guía todo el proceso de instalación, configuración de proveedores y uso diario en un solo lugar. Usa el script oficial de instalación de Athena, guarda los archivos en `~/.athena` y te da una GUI para chat, sesiones, perfiles, memoria, habilidades, herramientas, tareas programadas, gateways de mensajería y más.

## Instalación

<a href="https://athenaagents.cc/"><img width="380" alt="Descargar ahora" src="previews/download.webp" /></a>
...
> ```
>
> Seguimiento en [#109](https://github.com/dr-shabana/Athena-Desktop/issues/109).
...
- **Instalación guiada en el primer uso** de Athena Agent con seguimiento de progreso y resolución de dependencias
- **Backend local o remoto** — ejecuta Athena localmente en `127.0.0.1:8642`, o conecta la app a un servidor remoto con URL + clave API
...
- **Cambio de perfiles** — crea, elimina y cambia entre entornos Athena con configuración aislada
...
- **Athena Office (Claw3d)** — interfaz visual 3D con servidor de desarrollo y gestión de adaptadores
...
1. Pregunta si deseas ejecutar Athena **localmente** o conectarte a un **servidor remoto**.
2. **Modo local:** verifica si Athena ya está instalado en `~/.athena`; si no, ejecuta el instalador oficial con resolución de dependencias (Git, uv, Python 3.11+).
...
5. Guarda la configuración del proveedor y las claves API en los archivos de configuración de Athena.
...
| **Perfiles**      | Crea, elimina y cambia entre perfiles de Athena                                                 |
...
- Node.js y npm
- Un entorno tipo Unix para el instalador de Athena
- Acceso a internet para descargar Athena en la primera instalación
...
Cuando la app se abre por primera vez, detectará una instalación existente de Athena o se ofrecerá a instalarla.
...
Los archivos de Athena se gestionan en:

- `~/.athena`
- `~/.cortex/.env`
- `~/.cortex/config.yaml`
- `~/.cortex/athena-agent`
- `~/.cortex/profiles/` — directorios de perfiles con nombre
- `~/.cortex/state.db` — base de datos del historial de sesiones
- `~/.cortex/cron/jobs.json` — tareas programadas
...
- La app de escritorio depende del proyecto upstream Athena Agent para el comportamiento del agente y la ejecución de herramientas.
- El instalador integrado ejecuta el script oficial de instalación de Athena con `--skip-setup`, luego completa la configuración del proveedor en la GUI.
...
¡Las contribuciones son bienvenidas! Consulta la [Guía de contribución](CONTRIBUTING.md) para comenzar. Si no sabes por dónde empezar, mira los [issues abiertos](https://github.com/dr-shabana/Athena-Desktop/issues). ¿Encontraste un bug o tienes una solicitud de funcionalidad? [Abre un issue](https://github.com/dr-shabana/Athena-Desktop/issues/new).

## Proyecto relacionado

Para el agente central, documentación y flujos de trabajo CLI, consulta el repositorio principal de Athena Agent:
