export default {
  title: "Memória",
  subtitle: "O que o Athena lembra sobre você e seu ambiente entre as sessões.",
  sessions: "Sessões",
  messages: "Mensagens",
  memories: "Memórias",
  ...
  noMemoriesYet:
    "Nenhuma memória ainda. O Athena salvará fatos importantes conforme vocês conversam.",
  ...
  userProfileHint:
    "Conte ao Athena sobre você — nome, cargo, preferências, estilo de comunicação.",
  providersHint:
    "Provedores de memória plugáveis dão ao Athena uma memória de longo prazo avançada. A memória integrada (acima) está sempre ativa ao lado do provedor selecionado.",
