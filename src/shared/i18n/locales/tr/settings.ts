export default {
  ...
  analytics: {
    ...
    hint: "Athena Q'ı iyileştirmeye yardımcı olmak için anonim, toplulaştırılmış kullanım verilerini projenin PostHog örneğine gönderir. İstediğiniz zaman kapatabilirsiniz.",
    disclosure: {
  ...
  updateSuccess: "Athena başarıyla güncellendi.",
  ...
  poolHint:
    "Otomatik dönüşüm ve yük dengelemesi için aynı sağlayıcıya birden çok API Anahtarı ekleyin. Athena bunlar arasında geçiş yapacaktır.",
  add: "Ekle",
  remove: "Kaldır",
  keyLabel: "Anahtar",
  empty: "(boş)",
  dataSection: "Veri",
  dataHint:
    "Athena yapılandırmanızı, oturumlarınızı, yeteneklerinizi ve belleğinizi dışa veya içe aktarın.",
  ...
  migrationDesc:
    "<code>{{path}}</code> adresinde OpenClaw bulundu. Yapılandırmanızı, API anahtarlarınızı, oturumlarınızı ve yeteneklerinizi Athena'e taşıyabilirsiniz.",
  migrationDismiss: "Tekrar gösterme",
  migrating: "Taşınıyor...",
  migrateToAthena: "Athena'e Taşı",
  skip: "Geç",
  ...
  modeLocal: "Yerel",
  modeRemote: "Uzak",
  modeLocalHint: "Bu cihazda yüklü Athena kullanılıyor",
  modeRemoteHint:
    "Ağınızdaki veya buluttaki bir Athena API sunucusuna bağlanın",
  remoteUrl: "Uzak URL",
  remoteUrlHint:
    "Athena API sunucusu URL'si (/health ve /v1/chat/completions endpoint'lerini sunmalıdır)",
  ...
  serverConfigHint:
    "Uzak bir Athena sunucusuna bağlandınız. Model seçimi, sağlayıcı API anahtarları ve kimlik bilgileri sunucunun <code>~/.cortex/.env</code> ve <code>config.yaml</code> dosyalarında yönetilir. Bunları ana bilgisayarda düzenleyin (örn. <code>docker exec -it athena vi /opt/data/.env</code>) ve kabı yeniden başlatın.",
  connectionMode: "Mod",
  switchedToLocal: "Yerel moda geçildi",

  // Community
  communityTitle: "Topluluk",
  communityHint: "Sorular sormak, sorunları bildirmek ve diğer Athena kullanıcılarıyla sohbet etmek için Discord kanalımıza katılın.",
  joinDiscord: "Discord Kanalına Katıl",

  // SSH & Server Config
  modeSsh: "SSH Tüneli",
  modeSshHint: "SSH üzerinden uzak bir Athena'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  remoteEnvSshDesc: "SSH modu: uzak sunucudaki ~/.cortex/profiles/<profile>/.env dosyasına API_SERVER_KEY=<anahtarınız> ekleyin, ardından oradaki gateway'i yeniden başlatın.",
  remoteEnvDesc: "Uzak mod: uzak Athena sunucunuzdaki .env dosyasına API_SERVER_KEY=<anahtarınız> ekleyin, ardından gateway'i yeniden başlatın.",
  ...
  sshRemotePort: "Uzak Athena Portu",
  ...
  sshSubtitle: "SSH üzerinden uzak bir Athena'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  sshHostPlaceholder: "192.168.1.100 veya sunucum.local",
  sshUsernamePlaceholder: "athena",
  sshErrorRequired: "Sunucu ve kullanıcı adı gereklidir.",
  sshErrorConnection: "SSH üzerinden bağlanılamadı veya uzaktaki Athena'e ulaşılamadı. Şunlardan emin olun:\n• SSH anahtarı doğru (veya varsayılan ~/.ssh/id_rsa çalışıyor)\n• Uzak sunucuda Athena gateway'i çalışıyor\n• Uzak port doğru (varsayılan 8642)",
