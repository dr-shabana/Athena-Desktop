...
// Stub the window.athenaAPI surface used by the path-ref code path.
...
beforeEach(() => {
  (window as unknown as { athenaAPI: Record<string, unknown> }).athenaAPI = {
    ...
    expect(
      (
        window as unknown as {
          athenaAPI: { stageAttachment: ReturnType<typeof vi.fn> };
        }
      ).athenaAPI.stageAttachment,
